...
namespace PearsCleanV3.Infrastructure.Migrations
{
    ...
    [Migration("20240501124719_AddPicturesForMessages")]
    partial class AddPicturesForMessages
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PearsCleanV3.Domain.Entities.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("PearsCleanV3.Domain.Entities.Match", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PearsCleanV3.Domain.Entities.TodoList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PearsCleanV3.Domain.Entities.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PearsCleanV3.Domain.Entities.Match", b =>
                {
                    b.HasOne("PearsCleanV3.Domain.Entities.ApplicationUser", "MatchedUser")
                        .WithMany()
                        .HasForeignKey("MatchedUserId");

                    b.HasOne("PearsCleanV3.Domain.Entities.ApplicationUser", "SwipedUser")
                        .WithMany()
            ...
            modelBuilder.Entity("PearsCleanV3.Domain.Entities.TodoItem", b =>
                {
                    b.HasOne("PearsCleanV3.Domain.Entities.TodoList", "List")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("PearsCleanV3.Domain.Entities.TodoList", b =>
                {
                    b.OwnsOne("PearsCleanV3.Domain.ValueObjects.Colour", "Colour", b1 =>
                        {
